...
def benchmark
  Jscall.config module_names: [['Havlak', './', 'havlak.mjs']]
  #num_dummy_loops, find_loop_iterations, par_loops, ppar_loops, pppar_loops = 1, 1, 3, 3, 3
  num_dummy_loops, find_loop_iterations, par_loops, ppar_loops, pppar_loops = 1, 1, 10, 10, 5
  puts "Ruby   : #{LoopTesterApp.new.main(num_dummy_loops, find_loop_iterations, par_loops, ppar_loops, pppar_loops)}"
  puts "Ruby+JS: #{Jscall.Havlak.benchmark(num_dummy_loops, find_loop_iterations, par_loops, ppar_loops, pppar_loops)}"
end

require_relative './inspect'

def benchmark_ruby(n)
  num_dummy_loops, find_loop_iterations, par_loops, ppar_loops,
    pppar_loops = 1, 1, 10, 10, 5
  n.times do |i|
    t0 = Refgraph.clock
    res = LoopTesterApp.new.main(num_dummy_loops, find_loop_iterations,
                                 par_loops, ppar_loops, pppar_loops)
    puts Refgraph.clock(t0, "#{res}, #{i}-th ")
  end
end
...
def run_benchmark()
  ...
  Refgraph.config module_names: [['Havlak', './', 'havlak.mjs']]
  ...
  10.times do
    t00 = Refgraph.clock
    Jscall.Havlak.benchmark(num_dummy_loops, find_loop_iterations,
                            par_loops, ppar_loops, pppar_loops)
